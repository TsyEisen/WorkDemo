...
@interface RAFPFiltHouseTypeView ()
@property(nonatomic, strong)UIButton *conformBtn;
@property(nonatomic, strong)UIView *line;
@property(nonatomic, strong)UIButton *clearBtn;
@end

@implementation RAFPFiltHouseTypeView
...
- (void)setUpUI {
    ...
    CGFloat y = 20;
    UILabel *titleLabel = [self titleLabelWithTitle:@"户型" frame:CGRectMake(20, y, 36, 20)];
    [self addSubview:titleLabel];
    
    y += titleLabel.leju_height + 20;
    
    NSArray *items = [RAFPHouseFiltModel model].room;
    ...
    y += (([RAFPHouseFiltModel model].room.count - 1)/4 +1) * (itemH + margin) + 15;
